...
public static class SampleData
{
    ...
    public static Item GetItem(string ItemId)
    {
        ...
        return new() { ItemId = ItemId, ItemName = itemName, Data = Encoding.ASCII.GetBytes(itemName) };
    }
    ...
    public static List<Customer> GetCustomers()
    {
        ...
        var cust2 = new Customer
        {
            ...
            Address = new() { Name = "JockeAddr", PostalCode = "11111", Street = "Street 123" }
        };
    ...
    private static Order GenerateOrder1(Customer customer)
    {
        var order = new Order(customer)
        {
            ...
            OrderDate = new(2021, 4, 11, 2, 12, 10, 122, new(1, 0, 0)),
            Address = new() { Name = "Garden Inc", PostalCode = "1234", Street = "New Street 11" }
        };


        var line1 = new OrderLine(order) { LineNumber = 1, Price = 56.4M, Quantity = 10, Item = GetItem("12345") };
        order.Lines.Add(line1);

        var line2 = new OrderLine(order) { LineNumber = 2, Price = 11.4M, Quantity = 123.4, Item = GetItem("ABCDE") };
    ...
    private static Order GenerateOrder2(Customer customer)
    {
        var order = new Order(customer)
        {
            ...
            OrderDate = new(2022, 06, 21, 6, 33, 1, 221, new(3, 0, 0)),
            Address = new() { Name = "Justify AB", PostalCode = "54354", Street = "Holy Street" }
        };
        ...
        var line3 = new OrderLine(order) { LineNumber = 3, Price = 2345.50M, Quantity = 400, Item = GetItem("AA1234") };
    ...
    private static Order GenerateOrder3(Customer customer)
    {
        var order = new Order(customer)
        {
            ...
            OrderDate = new(2023, 06, 21, 6, 33, 1, 221, new(3, 0, 0)),
            Address = new() { Name = "Net Box 123", PostalCode = "123", Street = "Bang Street 99" }
        };


        var line1 = new OrderLine(order) { LineNumber = 1, Price = 5, Quantity = 10, Item = GetItem("ABC22") };
        order.Lines.Add(line1);

        var line2 = new OrderLine(order) { LineNumber = 2, Price = 111.4M, Quantity = 11, Item = GetItem("Vent") };
        order.Lines.Add(line2);
    ...
    private static Order GenerateOrder4(Customer customer)
    {
        var order = new Order(customer)
        {
            ...
            OrderDate = new(2021, 06, 21, 6, 33, 1, 221, new(3, 0, 0)),
            Address = new() { Name = "Delivery Street", PostalCode = "14332", Street = "Checker Street" }
        };


        var line1 = new OrderLine(order) { LineNumber = 1, Price = 99.3M, Quantity = 100, Item = GetItem("Main Unit") };
        order.Lines.Add(line1);
