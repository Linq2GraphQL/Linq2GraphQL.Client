        ...
        if (attribute != null)
        {
            ...
            foreach (var parameter in expression.Method.GetParameters())
            {
                ...
                if (graphQLArgumentAttribute != null)
                {
                    ...
                    argumentValues.Add(new(graphQLArgumentAttribute.GraphQLName, graphQLArgumentAttribute.GraphQLType,
            ...
            targetNode.AddChild(new(expression.Method, argumentValues));
