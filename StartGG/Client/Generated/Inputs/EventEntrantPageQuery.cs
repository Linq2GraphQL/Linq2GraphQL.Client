...
[JsonConverter(typeof(GraphInputConverter<EventEntrantPageQuery>))]
public partial class EventEntrantPageQuery : GraphInputBase
{
	[GraphQLMember("page")]
	...
	public EventEntrantPageQueryFilter Filter 
	{
		get => GetValue<EventEntrantPageQueryFilter>("filter");
