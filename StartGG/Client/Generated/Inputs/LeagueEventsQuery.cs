...
[JsonConverter(typeof(GraphInputConverter<LeagueEventsQuery>))]
public partial class LeagueEventsQuery : GraphInputBase
{
	[GraphQLMember("page")]
	...
	public LeagueEventsFilter Filter 
	{
		get => GetValue<LeagueEventsFilter>("filter");
