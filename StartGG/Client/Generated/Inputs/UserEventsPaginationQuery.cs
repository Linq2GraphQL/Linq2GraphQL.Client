...
[JsonConverter(typeof(GraphInputConverter<UserEventsPaginationQuery>))]
public partial class UserEventsPaginationQuery : GraphInputBase
{
	[GraphQLMember("page")]
	...
	public UserEventsPaginationFilter Filter 
	{
		get => GetValue<UserEventsPaginationFilter>("filter");
