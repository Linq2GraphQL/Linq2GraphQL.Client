...
[JsonConverter(typeof(GraphInputConverter<VideogameQuery>))]
public partial class VideogameQuery : GraphInputBase
{
	[GraphQLMember("page")]
	...
	public VideogamePageFilter Filter 
	{
		get => GetValue<VideogamePageFilter>("filter");
