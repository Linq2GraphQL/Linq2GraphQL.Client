...
[JsonConverter(typeof(GraphInputConverter<ParticipantPaginationQuery>))]
public partial class ParticipantPaginationQuery : GraphInputBase
{
	[GraphQLMember("page")]
	...
	public ParticipantPageFilter Filter 
	{
		get => GetValue<ParticipantPageFilter>("filter");
