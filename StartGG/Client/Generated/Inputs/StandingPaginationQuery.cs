...
[JsonConverter(typeof(GraphInputConverter<StandingPaginationQuery>))]
public partial class StandingPaginationQuery : GraphInputBase
{
	[GraphQLMember("page")]
	...
	public StandingPageFilter Filter 
	{
		get => GetValue<StandingPageFilter>("filter");
